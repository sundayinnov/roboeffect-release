#ifndef __ENGINE_V2_PARAM_H__
#define __ENGINE_V2_PARAM_H__

#include "stdio.h"
#include "type.h"

/*
	Audio Effect Lib Version: 2.57.0
*/
...
typedef struct _param_reverb_plate_me
{
	int16_t high_cutoff_frequency;
	int16_t modulation;
	int16_t predelay;
	...
	int16_t damping;
	int16_t wetdrymix;
	int16_t max_predelay;
}param_reverb_plate_me;

typedef struct _param_drc_sc
{
	int16_t mode;
	int16_t cf_type;
	int16_t q_l;
...
typedef struct _param_silence_detector_l
{
	int16_t pcm_amplitude;
}param_silence_detector_l;

typedef struct _param_phase_control_plus
{
	int16_t phase_shift;
}param_phase_control_plus;

typedef struct _param_peak_envelope
{
	int16_t release_time;
}param_peak_envelope;
...
typedef enum _REVERB_PLATE_ME_PARAMS_ENUM
{
	INDEX_REVERB_PLATE_ME_HIGH_CUTOFF_FREQUENCY = 0,
	INDEX_REVERB_PLATE_ME_MODULATION = 1,
	INDEX_REVERB_PLATE_ME_PREDELAY = 2,
	INDEX_REVERB_PLATE_ME_DIFFUSION = 3,
	INDEX_REVERB_PLATE_ME_DECAY = 4,
	INDEX_REVERB_PLATE_ME_DAMPING = 5,
	INDEX_REVERB_PLATE_ME_WETDRYMIX = 6,
	INDEX_REVERB_PLATE_ME_MAX_PREDELAY = 7,
}REVERB_PLATE_ME_PARAMS_ENUM;

typedef enum _DRC_SC_PARAMS_ENUM
{
	INDEX_DRC_SC_MODE = 0,
	INDEX_DRC_SC_CF_TYPE = 1,
	INDEX_DRC_SC_Q_L = 2,
	INDEX_DRC_SC_Q_H = 3,
	INDEX_DRC_SC_FC_0 = 4,
	INDEX_DRC_SC_FC_1 = 5,
	INDEX_DRC_SC_THRESHOLD_0 = 6,
	INDEX_DRC_SC_THRESHOLD_1 = 7,
	INDEX_DRC_SC_THRESHOLD_2 = 8,
	INDEX_DRC_SC_THRESHOLD_3 = 9,
	INDEX_DRC_SC_RATIO_0 = 10,
	INDEX_DRC_SC_RATIO_1 = 11,
	INDEX_DRC_SC_RATIO_2 = 12,
	INDEX_DRC_SC_RATIO_3 = 13,
	INDEX_DRC_SC_ATTACK_0 = 14,
	INDEX_DRC_SC_ATTACK_1 = 15,
	INDEX_DRC_SC_ATTACK_2 = 16,
	INDEX_DRC_SC_ATTACK_3 = 17,
	INDEX_DRC_SC_RELEASE_0 = 18,
	INDEX_DRC_SC_RELEASE_1 = 19,
	INDEX_DRC_SC_RELEASE_2 = 20,
	INDEX_DRC_SC_RELEASE_3 = 21,
	INDEX_DRC_SC_PREGAIN_0 = 22,
	INDEX_DRC_SC_PREGAIN_1 = 23,
	INDEX_DRC_SC_PREGAIN_2 = 24,
	INDEX_DRC_SC_PREGAIN_3 = 25,
}DRC_SC_PARAMS_ENUM;

typedef enum _SILENCE_DETECTOR_L_PARAMS_ENUM
{
	INDEX_SILENCE_DETECTOR_L_PCM_AMPLITUDE = 0,
}SILENCE_DETECTOR_L_PARAMS_ENUM;

typedef enum _PHASE_CONTROL_PLUS_PARAMS_ENUM
{
	INDEX_PHASE_CONTROL_PLUS_PHASE_SHIFT = 0,
}PHASE_CONTROL_PLUS_PARAMS_ENUM;

typedef enum _PEAK_ENVELOPE_PARAMS_ENUM
{
	INDEX_PEAK_ENVELOPE_RELEASE_TIME = 0,
}PEAK_ENVELOPE_PARAMS_ENUM;
...
/*default parameters*/
const unsigned char auto_tune_param[] = 
{
	0x00,/*enable*/
	0x04,0x00,//KEY
	0x00,0x00,//SNAP
	0x02,0x00,//PITCH_ACCURACY
};//auto_tune

const unsigned char dc_blocker_param[] = 
{
	0x00,/*enable*/
};//dc_blocker

const unsigned char drc_param[] = 
{
	0x00,/*enable*/
	0x00,0x00,//MODE
	0x03,0x00,//CF_TYPE
...
const unsigned char echo_param[] = 
{
	0x00,/*enable*/
	0x4C,0x1D,//CUTOFF_FREQUENCY
...
const unsigned char eq_param[] = 
{
	0x00,/*enable*/
	0x00,0x00,//PREGAIN
	0x00,0x00,//FIXED_POINT_FLOATING_POINT
...
const unsigned char noise_suppressor_expander_param[] = 
{
	0x00,/*enable*/
	0x6C,0xEE,//THRESHOLD
	0x03,0x00,//RATIO
...
const unsigned char freq_shifter_param[] = 
{
	0x00,/*enable*/
	0x04,0x00,//DELTAF
};//freq_shifter

const unsigned char howling_suppressor_param[] = 
{
	0x00,/*enable*/
	0x01,0x00,//SUPRESSION_MODE
};//howling_suppressor

const unsigned char noise_gate_param[] = 
{
	0x00,/*enable*/
	0xD3,0xFF,//LOWER
	0xD3,0xFF,//UPPER
...
const unsigned char pitch_shifter_param[] = 
{
	0x00,/*enable*/
	0x00,0x00,//KEY
};//pitch_shifter

const unsigned char reverb_param[] = 
{
	0x00,/*enable*/
	0x32,0x00,//DRY
	0x64,0x00,//WET
...
const unsigned char silence_detector_param[] = 
{
	0x00,/*enable*/
	0x00,0x00,//PCM_AMPLITUDE
};//silence_detector

const unsigned char three_d_param[] = 
{
	0x00,/*enable*/
	0x32,0x00,//INTENSITY
};//three_d

const unsigned char virtual_bass_param[] = 
{
	0x00,/*enable*/
...
const unsigned char voice_changer_param[] = 
{
	0x00,/*enable*/
	0xC8,0x00,//PITCH
	0x82,0x00,//FORMANT
...
const unsigned char gain_control_param[] = 
{
	0x00,/*enable*/
	0x00,0x00,//MUTE
	0x00,0x00,//GAIN
...
const unsigned char vocal_cut_param[] = 
{
	0x00,/*enable*/
	0x64,0x00,//WETDRYMIX
};//vocal_cut

const unsigned char reverb_pro_param[] = 
{
	0x00,/*enable*/
	0xF6,0xFF,//DRY
	0x00,0x00,//WET
...
const unsigned char voice_changer_pro_param[] = 
{
	0x00,/*enable*/
	0xC8,0x00,//PITCH
	0x82,0x00,//FORMANT
...
const unsigned char phase_control_param[] = 
{
	0x00,/*enable*/
	0x00,0x00,//PHASE_SHIFT
};//phase_control

const unsigned char vocal_remover_param[] = 
{
	0x00,/*enable*/
	0xC8,0x00,//LOWER_FREQUENCY
	0x98,0x3A,//HIGHER_FREQUENCY
};//vocal_remover

const unsigned char pitch_shifter_pro_param[] = 
{
	0x00,/*enable*/
	0x00,0x00,//KEY
};//pitch_shifter_pro

const unsigned char virtual_bass_classic_param[] = 
{
	0x00,/*enable*/
	0x64,0x00,//CUTOFF_FREQUENCY
	0x23,0x00,//INTENSITY
...
const unsigned char pcm_delay_param[] = 
{
	0x00,/*enable*/
	0xE4,0x06,//DELAY
	0x9D,0x08,//MAX_DELAY
	0x01,0x00,//HIGH_QUALITY_ENABLE
};//pcm_delay

const unsigned char harmonic_exciter_param[] = 
{
	0x00,/*enable*/
...
const unsigned char chorus_param[] = 
{
	0x00,/*enable*/
...
const unsigned char auto_wah_param[] = 
{
	0x00,/*enable*/
	0x0A,0x00,//MODULATION_RATE
	0xC8,0x00,//MINIMUM_FREQUENCY
	0xD0,0x07,//MAXIMUM_FREQUENCY
	0x14,0x00,//DEPTH
	0x00,0x00,//DRY
	0x64,0x00,//WET
};//auto_wah

const unsigned char stereo_widener_param[] = 
{
	0x00,/*enable*/
	0x00,0x00,//SHAPING
};//stereo_widener

const unsigned char pingpong_param[] = 
{
	0x00,/*enable*/
	0xD8,0xFF,//ATTENUATION
	0xFA,0x00,//DELAY
	0x00,0x00,//HIGH_QUALITY_ENABLE
	0x32,0x00,//WETDRYMIX
	0xE8,0x03,//MAX_DELAY
...
const unsigned char three_d_plus_param[] = 
{
	0x00,/*enable*/
	0x32,0x00,//INTENSITY
};//three_d_plus

const unsigned char sine_generator_param[] = 
{
	0x00,/*enable*/
	0x03,0x00,//CHANNEL_ENABLE
	0xE8,0x03,//LEFT_FREQUENCY
	0xE8,0x03,//RIGHT_FREQUENCY
	0x38,0xFF,//LEFT_AMPLITUDE
	0x38,0xFF,//RIGHT_AMPLITUDE
};//sine_generator

const unsigned char noise_suppressor_blue_param[] = 
{
	0x00,/*enable*/
	0x05,0x00,//LEVEL
};//noise_suppressor_blue

const unsigned char flanger_param[] = 
{
	0x00,/*enable*/
	0x01,0x00,//DELAY_LENGTH
	0x01,0x00,//MODULATION_DEPTH
	0x64,0x00,//MODULATION_RATE
	0x46,0x00,//FEEDBACK
	0x3B,0x00,//DRY
	0x64,0x00,//WET
};//flanger

const unsigned char freq_shifter_fine_param[] = 
{
	0x00,/*enable*/
	0xF4,0x01,//DELTAF
};//freq_shifter_fine

const unsigned char over_drive_param[] = 
{
	0x00,/*enable*/
	0x45,0xFC,//THRESHOLD_COMPRESSION
};//over_drive

const unsigned char distortion_ds1_param[] = 
{
	0x00,/*enable*/
	0x00,0x00,//DISTORTION_LEVEL
	0x00,0x00,//OUT_LEVEL
};//distortion_ds1

const unsigned char eq_drc_param[] = 
{
	0x00,/*enable*/
	0x00,0x00,//RESERVED0
	0x00,0x00,//RESERVED1
	...
	0x00,0x00,//FILTER10_GAIN
	0x00,0x00,//DRC_MODE
	0x03,0x00,//DRC_CF_TYPE
	0xD4,0x02,//DRC_Q_L
	0xD4,0x02,//DRC_Q_H
	0x2C,0x01,//DRC_FC_0
	0xB8,0x0B,//DRC_FC_1
	0x00,0x00,//DRC_THRESHOLD_0
	0x00,0x00,//DRC_THRESHOLD_1
	0x00,0x00,//DRC_THRESHOLD_2
	0x00,0x00,//DRC_THRESHOLD_3
	0x64,0x00,//DRC_RATIO_0
	0x64,0x00,//DRC_RATIO_1
	0x64,0x00,//DRC_RATIO_2
	0x64,0x00,//DRC_RATIO_3
	0x01,0x00,//DRC_ATTACK_0
	0x01,0x00,//DRC_ATTACK_1
	0x01,0x00,//DRC_ATTACK_2
	0x01,0x00,//DRC_ATTACK_3
	0xE8,0x03,//DRC_RELEASE_0
	0xE8,0x03,//DRC_RELEASE_1
	0xE8,0x03,//DRC_RELEASE_2
	0xE8,0x03,//DRC_RELEASE_3
	0x00,0x00,//DRC_PREGAIN_0
	0x00,0x00,//DRC_PREGAIN_1
	0x00,0x00,//DRC_PREGAIN_2
	0x00,0x00,//DRC_PREGAIN_3
};//eq_drc

const unsigned char aec_param[] = 
{
	0x00,/*enable*/
	0x03,0x00,//ECHO_SUPPRESSION_LEVEL
};//aec

const unsigned char compander_param[] = 
{
	0x00,/*enable*/
	0x60,0xF0,//THRESHOLD
...
const unsigned char low_level_compressor_param[] = 
{
	0x00,/*enable*/
	0x00,0xE7,//THRESHOLD
	0x5C,0x08,//GAIN
...
const unsigned char beat_tracker_param[] = 
{
	0x00,/*enable*/
	0xA6,0xFF,//SILENCE_THRESHOLD
	0x00,0x00,//BEAT_DETECT
	0x00,0x00,//BPM
};//beat_tracker

const unsigned char engine_sound_param[] = 
{
	0x00,/*enable*/
	0xBC,0x02,//IDLE_RPM
	0x10,0x27,//MAX_RPM
	0x00,0x00,//STARTUP_SOUND
	0x00,0x00,//MATERIAL
	0xBC,0x02,//CURRENT_RPM
};//engine_sound

const unsigned char biquad_param[] = 
{
	0x00,/*enable*/
	0x00,0x00,//RESERVED0
	0x01,0x00,//FIXED_POINT_FLOATING_POINT
	0x00,0x00,//RESERVED1
	0x00,0x00,//FILTER_TYPE
	0xC8,0x00,//FILTER_F0
	0xD4,0x02,//FILTER_Q
	0x00,0x00,//FILTER_GAIN
};//biquad

const unsigned char chorus2_param[] = 
{
	0x00,/*enable*/
	0x19,0x00,//DELAY_LENGTH
	0x32,0x00,//DRY
	0x32,0x00,//WET1
	0x32,0x00,//WET2
	0x03,0x00,//MODULATION1_DEPTH
	0x3C,0x00,//MODULATION1_RATE
	0x01,0x00,//MODULATION2_DEPTH
	0x8A,0x02,//MODULATION2_RATE
};//chorus2

const unsigned char reverb_plate_param[] = 
{
	0x00,/*enable*/
	0x20,0x4E,//HIGH_CUTOFF_FREQUENCY
...
const unsigned char howling_suppressor_fine_param[] = 
{
	0x00,/*enable*/
	0x00,0x02,//Q_MIN
	0x00,0x14,//Q_MAX
...
const unsigned char howling_guard_param[] = 
{
	0x00,/*enable*/
...
const unsigned char virtual_bass_td_param[] = 
{
	0x00,/*enable*/
	0x64,0x00,//CUTOFF_FREQUENCY
	0x23,0x00,//INTENSITY
...
const unsigned char over_drive_ploy_param[] = 
{
	0x00,/*enable*/
	0x00,0x00,//GAIN
	0x00,0x00,//OUT_LEVEL
...
const unsigned char tremolo_param[] = 
{
	0x00,/*enable*/
	0x00,0x00,//WAVE_TYPE
	0x32,0x00,//MOD_DEPTH
...
const unsigned char beamforming_param[] = 
{
	0x00,/*enable*/
	0x04,0x00,//CHANNEL_TO_PROCESS
	0x54,0xF2,//POWER_THRESHOLD
	0xF6,0xFF,//DECAY_RATE
	0x64,0x00,//MIC_MAX_SPACING
	0x00,0x00,//NEAREST_MIC
	0x00,0x00,//CH1_DELAY_SAMPLES
	0x00,0x00,//CH2_DELAY_SAMPLES
	0x00,0x00,//CH3_DELAY_SAMPLES
	0x00,0x00,//CH4_DELAY_SAMPLES
	0x00,0x00,//SIGNAL_OR_NOISE
};//beamforming

const unsigned char virtual_surround_2ch_param[] = 
{
	0x00,/*enable*/
};//virtual_surround_2ch

const unsigned char robot_tone_param[] = 
{
	0x00,/*enable*/
	0xB9,0x01,//STEP_SIZE
};//robot_tone

const unsigned char noise_generator_param[] = 
{
	0x00,/*enable*/
	0x00,0x00,//NOISE_TYPE
	0x00,0x00,//AMPLITUDE
};//noise_generator

const unsigned char noise_suppressor_blue_dual_param[] = 
{
	0x00,/*enable*/
	0x01,0x00,//NS_LEVEL
};//noise_suppressor_blue_dual

const unsigned char phase_inverter_param[] = 
{
	0x00,/*enable*/
	0x00,0x00,//PHASE_DIFFERENCE
};//phase_inverter

const unsigned char filter_butterworth_param[] = 
{
	0x00,/*enable*/
	0x00,0x00,//FILTER_TYPE
	0x00,0x00,//FILTER_ORDER
	0x90,0x01,//CUTOFF_FREQUENCY
};//filter_butterworth

const unsigned char dynamic_eq_param[] = 
{
	0x00,/*enable*/
	0x48,0xF4,//LOW_ENERGY_THRESHOLD
	0x24,0xFA,//NORMAL_ENERGY_THRESHOLD
	0xA8,0xFD,//HIGH_ENERGY_THRESHOLD
	0x64,0x00,//ATTACK_TIME
	0xC8,0x00,//RELEASE_TIME
	0x00,0x00,//EQ_LOW
	0x00,0x00,//EQ_HIGH
};//dynamic_eq

const unsigned char vad_param[] = 
{
	0x00,/*enable*/
	0x01,0x00,//POST_PROCESSING
	0x00,0x00,//VOICED
};//vad

const unsigned char lr_balancer_param[] = 
{
	0x00,/*enable*/
	0x00,0x00,//BALANCE
};//lr_balancer

const unsigned char howling_suppressor_specified_param[] = 
{
	0x00,/*enable*/
	0x00,0x00,//FILTER_ENABLE_1
	0xDC,0x00,//CENTER_FREQ1
	0x80,0x02,//Q1
	0xC4,0xFF,//DEPTH1
	0x00,0x00,//FILTER_ENABLE_2
	0xFE,0x01,//CENTER_FREQ2
	0x80,0x02,//Q2
	0xC4,0xFF,//DEPTH2
	0x00,0x00,//FILTER_ENABLE_3
	0xEC,0x04,//CENTER_FREQ3
	0x80,0x02,//Q3
	0xC4,0xFF,//DEPTH3
	0x00,0x00,//FILTER_ENABLE_4
	0x66,0x09,//CENTER_FREQ4
	0x80,0x02,//Q4
	0xC4,0xFF,//DEPTH4
	0x00,0x00,//FILTER_ENABLE_5
	0x1D,0x0C,//CENTER_FREQ5
	0x80,0x02,//Q5
	0xC4,0xFF,//DEPTH5
	0x00,0x00,//FILTER_ENABLE_6
	0x44,0x0F,//CENTER_FREQ6
	0x80,0x02,//Q6
	0xC4,0xFF,//DEPTH6
};//howling_suppressor_specified

const unsigned char drc_legacy_param[] = 
{
	0x00,/*enable*/
	0x2C,0x01,//CF
	0x00,0x00,//DRC_MODE
...
const unsigned char pcm_delay_ms_param[] = 
{
	0x00,/*enable*/
	0x14,0x00,//DELAY
	0xC8,0x00,//MAX_DELAY
...
const unsigned char distortion_exp_param[] = 
{
	0x00,/*enable*/
	0x00,0x00,//GAIN
	0x00,0x00,//DRY
...
const unsigned char vibrato_param[] = 
{
	0x00,/*enable*/
	0x20,0x03,//MOD_DEPTH
	0xBC,0x02,//MOD_RATE
...
const unsigned char pitch_detector_param[] = 
{
	0x00,/*enable*/
	0x50,0x00,//PITCH_MIN
	0x78,0x05,//PITCH_MAX
	0xB0,0x04,//WINDOW_SIZE
	0x28,0x23,//CONFIDENCE_THRESHOLD
	0x00,0x00,//CONFIDENCE
	0x00,0x00,//PCM_AMPLITUDE
};//pitch_detector

const unsigned char filter_fir_param[] = 
{
	0x00,/*enable*/
	0x00,0x00,//COEFFICIENTS_INDEX
};//filter_fir

const unsigned char noise_suppressor_blue_adv_param[] = 
{
	0x00,/*enable*/
	0xE8,0x03,//INITIAL_ENV_TIME
	0xB8,0x0B,//SMOOTH_TIME
	0x0F,0x00,//LEVEL
};//noise_suppressor_blue_adv

const unsigned char lr_swap_param[] = 
{
	0x00,/*enable*/
};//lr_swap

const unsigned char reverb_plate_me_param[] = 
{
	0x00,/*enable*/
	0x20,0x4E,//HIGH_CUTOFF_FREQUENCY
	0x01,0x00,//MODULATION
	...
	0x05,0x00,//DAMPING
	0x50,0x00,//WETDRYMIX
	0x72,0x03,//MAX_PREDELAY
};//reverb_plate_me

const unsigned char drc_sc_param[] = 
{
	0x00,/*enable*/
	0x00,0x00,//MODE
	0x03,0x00,//CF_TYPE
...
const unsigned char silence_detector_l_param[] = 
{
	0x00,/*enable*/
	0x00,0x00,//PCM_AMPLITUDE
};//silence_detector_l

const unsigned char phase_control_plus_param[] = 
{
	0x00,/*enable*/
	0x00,0x00,//PHASE_SHIFT
};//phase_control_plus

const unsigned char peak_envelope_param[] = 
{
	0x00,/*enable*/
	0xC8,0x00,//RELEASE_TIME
};//peak_envelope

const unsigned char fader_param[] = 
{
	0x00,/*enable*/
	0x00,0x04,//FADER_STEPS
	0x00,0x00,//TRIGGER
	0x00,0x00,//STATUS
};//fader

const unsigned char downmix_2to1_param[] = 
{
	0x00,/*enable*/
};//downmix_2to1

const unsigned char upmix_1to2_param[] = 
{
	0x00,/*enable*/
};//upmix_1to2

const unsigned char channel_combiner_param[] = 
{
	0x00,/*enable*/
};//channel_combiner

const unsigned char channel_selector_param[] = 
{
	0x00,/*enable*/
	0x00,0x00,//SELECTED_CHANNEL
};//channel_selector

const unsigned char route_selector_param[] = 
{
	0x00,/*enable*/
	0x00,0x00,//SELECTED_ROUTE
};//route_selector

#endif //__ENGINE_V3_PARAM_H__
