...
const roboeffect_effect_property_struct effect_property_for_robo[] = {
	...
	{ROBOEFFECT_PITCH_SHIFTER, ROBOEFFECT_CH_MONO_STEREO, ROBOEFFECT_PITCH_SHIFTER_PARAM_LEN, FZ_RANGE, 2, {64,288},
	...
	{ROBOEFFECT_PHASE_CONTROL, ROBOEFFECT_CH_MONO_STEREO, ROBOEFFECT_PHASE_CONTROL_PARAM_LEN, FZ_RANGE, 2, {1,256},
	...
	{ROBOEFFECT_NOISE_SUPPRESSOR_BLUE, ROBOEFFECT_CH_MONO, ROBOEFFECT_NOISE_SUPPRESSOR_BLUE_PARAM_LEN, FZ_RANGE, 2, {64,512},
	...
	{ROBOEFFECT_NOISE_SUPPRESSOR_BLUE_ADV, ROBOEFFECT_CH_MONO, ROBOEFFECT_NOISE_SUPPRESSOR_BLUE_ADV_PARAM_LEN, FZ_RANGE, 2, {64,512},
	...
	{ROBOEFFECT_LR_SWAP, ROBOEFFECT_CH_STEREO, ROBOEFFECT_LR_SWAP_PARAM_LEN, FZ_ANY, 0, {0},
#if LR_SWAP_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(lr_swap), ROBOEFFECT_EFF_IF_NAME_CONF(lr_swap), ROBOEFFECT_EFF_IF_NAME_APPLY(lr_swap), ROBOEFFECT_EFF_IF_NAME_MEMORY_SIZE(lr_swap),
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), ROBOEFFECT_EFF_IF_NAME_MEMORY_SIZE(null),
#endif/*LR_SWAP_ENABLE*/
	},

	{ROBOEFFECT_REVERB_PLATE_ME, ROBOEFFECT_CH_MONO_STEREO, ROBOEFFECT_REVERB_PLATE_ME_PARAM_LEN, FZ_ANY, 0, {0},
#if REVERB_PLATE_ME_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(reverb_plate_me), ROBOEFFECT_EFF_IF_NAME_CONF(reverb_plate_me), ROBOEFFECT_EFF_IF_NAME_APPLY(reverb_plate_me), ROBOEFFECT_EFF_IF_NAME_MEMORY_SIZE(reverb_plate_me),
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), ROBOEFFECT_EFF_IF_NAME_MEMORY_SIZE(null),
#endif/*REVERB_PLATE_ME_ENABLE*/
	},

	{ROBOEFFECT_DRC_SC, ROBOEFFECT_CH_MONO_STEREO, ROBOEFFECT_DRC_SC_PARAM_LEN, FZ_ANY, 0, {0},
#if DRC_SC_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(drc_sc), ROBOEFFECT_EFF_IF_NAME_CONF(drc_sc), ROBOEFFECT_EFF_IF_NAME_APPLY(drc_sc), ROBOEFFECT_EFF_IF_NAME_MEMORY_SIZE(drc_sc),
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), ROBOEFFECT_EFF_IF_NAME_MEMORY_SIZE(null),
#endif/*DRC_SC_ENABLE*/
	},

	{ROBOEFFECT_SILENCE_DETECTOR_L, ROBOEFFECT_CH_NA, ROBOEFFECT_SILENCE_DETECTOR_L_PARAM_LEN, FZ_ANY, 0, {0},
#if SILENCE_DETECTOR_L_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(silence_detector_l), ROBOEFFECT_EFF_IF_NAME_CONF(silence_detector_l), ROBOEFFECT_EFF_IF_NAME_APPLY(silence_detector_l), ROBOEFFECT_EFF_IF_NAME_MEMORY_SIZE(silence_detector_l),
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), ROBOEFFECT_EFF_IF_NAME_MEMORY_SIZE(null),
#endif/*SILENCE_DETECTOR_L_ENABLE*/
	},

	{ROBOEFFECT_PHASE_CONTROL_PLUS, ROBOEFFECT_CH_MONO_STEREO, ROBOEFFECT_PHASE_CONTROL_PLUS_PARAM_LEN, FZ_RANGE, 2, {1,512},
#if PHASE_CONTROL_PLUS_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(phase_control_plus), ROBOEFFECT_EFF_IF_NAME_CONF(phase_control_plus), ROBOEFFECT_EFF_IF_NAME_APPLY(phase_control_plus), ROBOEFFECT_EFF_IF_NAME_MEMORY_SIZE(phase_control_plus),
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), ROBOEFFECT_EFF_IF_NAME_MEMORY_SIZE(null),
#endif/*PHASE_CONTROL_PLUS_ENABLE*/
	},

	{ROBOEFFECT_PEAK_ENVELOPE, ROBOEFFECT_CH_MONO_STEREO, ROBOEFFECT_PEAK_ENVELOPE_PARAM_LEN, FZ_ANY, 0, {0},
#if PEAK_ENVELOPE_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(peak_envelope), ROBOEFFECT_EFF_IF_NAME_CONF(peak_envelope), ROBOEFFECT_EFF_IF_NAME_APPLY(peak_envelope), ROBOEFFECT_EFF_IF_NAME_MEMORY_SIZE(peak_envelope),
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), ROBOEFFECT_EFF_IF_NAME_MEMORY_SIZE(null),
#endif/*PEAK_ENVELOPE_ENABLE*/
	},
...
0x02, 0x2F, 0x01, //roboeffect_library@2.47.1
0x02, 0x39, 0x00, //audio_effect_library@2.57.0
...
0x00, //effect category
0x02, //bits width is 16/24
0x08, //frame size formula length
0x5B, 0x36, 0x34, 0x3A, 0x32, 0x38, 0x38, 0x5D, //[64:288]
0x01, //input counter
...
0x04, 0x04, 0x03, //virtual_bass@4.4.3
0x0C, //effect name length
...
0x03, 0x02, 0x00, //noise_suppressor_blue@3.2.0
...
0x02, //bits width is 16/24
0x08, //frame size formula length
0x5B, 0x36, 0x34, 0x3A, 0x35, 0x31, 0x32, 0x5D, //[64:512]
0x01, //input counter
...
0x01, 0x03, 0x03, //engine_sound@1.3.3
0x0C, //effect name length
...
0x04, 0x02, 0x00, //noise_suppressor_blue_adv@4.2.0
0x19, //effect name length
...
0x01, 0x00, 0x00, //lr_swap@1.0.0
0x07, //effect name length
0x6C, 0x72, 0x5F, 0x73, 0x77, 0x61, 0x70, //lr_swap
0x00, //effect category
0x02, //bits width is 16/24
0x06, //frame size formula length
0x46, 0x5A, 0x5F, 0x41, 0x4E, 0x59, //FZ_ANY
...
/*****lr_swap end*****/
/*****reverb_plate_me*****/
0x0E, 0x01, //item len=270
0x03, 0x01, 0x02, //reverb_plate_me@3.1.2
0x0F, //effect name length
0x72, 0x65, 0x76, 0x65, 0x72, 0x62, 0x5F, 0x70, 0x6C, 0x61, 0x74, 0x65, 0x5F, 0x6D, 0x65, //reverb_plate_me
0x00, //effect category
0x02, //bits width is 16/24
0x06, //frame size formula length
0x46, 0x5A, 0x5F, 0x41, 0x4E, 0x59, //FZ_ANY
...
0x0C, //index: 07, max_predelay
0x6D, 0x61, 0x78, 0x5F, 0x70, 0x72, 0x65, 0x64, 0x65, 0x6C, 0x61, 0x79, 
0x02, //value: value
0x00, 0x00, //min 0
0xFF, 0x7F, //max 32767
0x01, 0x00, //step 1
0x72, 0x03, //default: 882
0x01, 0x00, //method: METHOD_INIT
...
0x00, 0x02, //damping: 0,2
0x01, 0x02, //wetdrymix: 1,2
0x02, 0x00, //max_predelay: 2,0
/*****reverb_plate_me end*****/
/*****drc_sc*****/
0x11, 0x03, //item len=785
0x01, 0x01, 0x00, //drc_sc@1.1.0
0x06, //effect name length
0x64, 0x72, 0x63, 0x5F, 0x73, 0x63, //drc_sc
0x00, //effect category
0x02, //bits width is 16/24
0x06, //frame size formula length
0x46, 0x5A, 0x5F, 0x41, 0x4E, 0x59, //FZ_ANY
...
0x01, 0x02, 0x01, //silence_detector_l@1.2.1
0x12, //effect name length
0x73, 0x69, 0x6C, 0x65, 0x6E, 0x63, 0x65, 0x5F, 0x64, 0x65, 0x74, 0x65, 0x63, 0x74, 0x6F, 0x72, 0x5F, 0x6C, //silence_detector_l
0x00, //effect category
0x02, //bits width is 16/24
0x06, //frame size formula length
0x46, 0x5A, 0x5F, 0x41, 0x4E, 0x59, //FZ_ANY
...
0x02, 0x04, //ui_grid_size is 2,4
0x01, 0xFF, //PCM amplitude: 1,255
/*****silence_detector_l end*****/
/*****phase_control_plus*****/
0x4A, 0x00, //item len=74
0x02, 0x00, 0x00, //phase_control_plus@2.0.0
0x12, //effect name length
0x70, 0x68, 0x61, 0x73, 0x65, 0x5F, 0x63, 0x6F, 0x6E, 0x74, 0x72, 0x6F, 0x6C, 0x5F, 0x70, 0x6C, 0x75, 0x73, //phase_control_plus
0x00, //effect category
0x02, //bits width is 16/24
0x07, //frame size formula length
0x5B, 0x31, 0x3A, 0x35, 0x31, 0x32, 0x5D, //[1:512]
0x01, //input counter
...
0x00, //ui_layout is auto
/*****phase_control_plus end*****/
/*****peak_envelope*****/
0x40, 0x00, //item len=64
0x01, 0x00, 0x00, //peak_envelope@1.0.0
0x0D, //effect name length
0x70, 0x65, 0x61, 0x6B, 0x5F, 0x65, 0x6E, 0x76, 0x65, 0x6C, 0x6F, 0x70, 0x65, //peak_envelope
0x00, //effect category
0x02, //bits width is 16/24
0x06, //frame size formula length
0x46, 0x5A, 0x5F, 0x41, 0x4E, 0x59, //FZ_ANY
...
{
    return sizeof(effect_property_for_display);// 16933 bytes
}
...
int16_t *roboeffect_get_param_by_raw_data(uint8_t addr, uint8_t *enable, uint8_t *len, const uint8_t *parameters)
{
	...
	const uint8_t *ptr = parameters + 10;//start from the first item
...
uint16_t roboeffect_get_param_index_by_name(char *effect_type_name, char *param_name)
{
	...
	while(pp < effect_property_for_display + sizeof_effect_property_for_display())
	{
		...
		const uint8_t *look = pp + 5;
		
		if((size_t)(*look) == strlen(effect_type_name) && strncmp(effect_type_name, look+1, *look) == 0)
		{
			const uint8_t *qq;
			uint8_t io_cnt, param_cnt;
			qq = look + 1 + *look + 2;
