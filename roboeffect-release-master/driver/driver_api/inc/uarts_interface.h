...
extern uint32_t (*UARTS_Recv_MAP[])(uint8_t* RecvBuf, uint32_t BufLen,uint32_t TimeOut);

extern bool (*UARTS_RecvByte_MAP[])(uint8_t* Val);

extern uint32_t (*UARTS_Send_MAP[])(uint8_t* SendBuf, uint32_t BufLen,uint32_t TimeOut);
...
extern int32_t (*UARTS_DMA_RxDataLen_MAP[])(void);

extern int32_t (*UARTS_DMA_TxDataLen_MAP[])(void);
...
extern void (*UARTS_DMA_RxChannelEn_MAP[])(void);

extern void (*UARTS_DMA_TxChannelEn_MAP[])(void);

extern void (*UARTS_DMA_RxChannelDisable_MAP[])(void);

extern void (*UARTS_DMA_TxChannelDisable_MAP[])(void);
