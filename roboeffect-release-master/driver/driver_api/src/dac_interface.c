...
void AudioDAC_Init(DAC_MODULE DACModule, uint32_t SampleRate, void* Buf1, uint16_t Len1, void* Buf2, uint16_t Len2)
{
	...
	//CLK select
	// Clock_AudioPllClockSet(PLL_CLK_2, PLL_CLK_GEN, 0); // 12.288M
	// Clock_AudioPllClockSet(PLL_CLK_1, PLL_CLK_GEN, 0); // 11.2896M

	Clock_AudioPllClockAutoSet(PLL_CLK_1);
	Clock_AudioPllClockAutoSet(PLL_CLK_2);
