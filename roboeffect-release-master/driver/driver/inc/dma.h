...
typedef enum
{
	...
	PERIPHERAL_ID_SDIO0_RX,			//3
	PERIPHERAL_ID_SDIO0_TX,			//4
	PERIPHERAL_ID_UART0_RX,			//5
	PERIPHERAL_ID_SDIO1_RX,			//6
	PERIPHERAL_ID_SDIO1_TX,			//7
	...
	PERIPHERAL_ID_PSRAM_TX,			//15
	PERIPHERAL_ID_PSRAM_RX,			//16
	PERIPHERAL_ID_TIMER4,			//17
	PERIPHERAL_ID_AUDIO_ADC0_RX,	//18
	PERIPHERAL_ID_AUDIO_ADC1_RX,	//19
	PERIPHERAL_ID_AUDIO_DAC0_TX,	//20
	PERIPHERAL_ID_AUDIO_DAC1_TX,	//21
	PERIPHERAL_ID_I2S0_TX,			//22
	PERIPHERAL_ID_I2S0_RX,			//23
	PERIPHERAL_ID_I2S1_TX,			//24
	PERIPHERAL_ID_I2S1_RX,			//25
	PERIPHERAL_ID_ADC,     			//26
	PERIPHERAL_ID_SOFTWARE,			//27
